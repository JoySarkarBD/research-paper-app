      ...
      <div className="flex flex-wrap mt-4">
        ...
        <div className="w-full pt-6">
          <div className="grid grid-cols-1 md:grid-cols-2  gap-4">
            <div>
              {/* Problem part */}
              <div className="bg-[linear-gradient(_to_right,#050418,#121223,#1c1a2f,#27233b,#322b47,#342b49,#372c4c,#392c4e,#322548,#2b1e41,#24183b,#1d1135_)] shadow-[0_50px_30px_-20px_#0003] p-8 rounded-[38px] mb-4">
               ...
               */}
              <div className="bg-[linear-gradient(_to_right,#090d25,#0c112a,#0e152f,#101735,#131a3a,#151c3c,#181f3e,#1a2140,#1c233f,#1f253f,#21273e,#24293d_)] shadow-[0_50px_30px_-20px_#0003] p-8 rounded-[38px] mb-4">
